...
modindex_common_prefix = ["umls_downloader."]
...
htmlhelp_basename = "UMLSDownloaderdoc"
...
texinfo_documents = [
    (
        ...
        author,
        "Charles Tapley Hoyt",
        "A tool for navigating the UMLS Terminology Services.",
        "Miscellaneous",
    ),
]
